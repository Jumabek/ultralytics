...
class BaseModel(nn.Module):
    ...
    def predict(self, x, profile=False, visualize=False, augment=False, embed=None, appearance_feature_layer=None):
        """
        ...
        return self._predict_once(x, profile, visualize, appearance_feature_layer=appearance_feature_layer)

    def _predict_once(self, x, profile=False, visualize=False, appearance_feature_layer=None):
        """
        Perform a forward pass through the network.
        ...
        for i, m in enumerate(self.model):
            ...
            if layer_name == appearance_feature_layer:
        ...
        # return the final output and the activations of the first layer
        return x + (layers,)
