...
class AutoBackend(nn.Module):
    ...
    def forward(self, im, augment=False, visualize=False, embed=None, appearance_feature_layer=None):
        """
        ...
        if self.pt or self.nn_module:  # PyTorch
            y = self.model(im, augment=augment, visualize=visualize,
                           embed=embed, appearance_feature_layer=appearance_feature_layer)
